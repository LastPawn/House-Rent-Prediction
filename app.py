...
def home1():
    if request.method =="POST":
        ...
        gate_community = 'gate_community_Yes',
        wheelchairadption = "wheelchairadption_Yes"
       ...
       'brok_amt', 'mnt_amt', 'address_num', 'furnishing_Semifurnished',
       'furnishing_Unfurnished', 'floor_type_Ceramic', 'floor_type_Concrete',
       'floor_type_Granite', 'floor_type_IPSFinish', 'floor_type_Marble',
       'floor_type_Mosaic', 'floor_type_Not provided', 'floor_type_Others',
       'floor_type_Polished concrete', 'floor_type_Spartex',
       'floor_type_Stone', 'floor_type_Vinyl', 'floor_type_Vitrified',
       'floor_type_Wood', 'gate_community_Yes', 'wheelchairadption_Yes']
        ...
        return render_template("result.html", prediction_text=f"Rent is {rent} Rs")
